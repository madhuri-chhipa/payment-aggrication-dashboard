...
class UserBankAccountController extends Controller
{
  ...
  {
    return view('user.user_bank_accounts.list');
  }
  ...
  public function store(Request $request)
  {
    ...
    UserBankAccount::create($request->all());
  ...
  {
    return response()->json(UserBankAccount::findOrFail($id));
  }
  ...
  {
    UserBankAccount::findOrFail($id)->delete();
