...
@section('page-script')
  <script>
    window.routes = {
      txnData: "{{ route('admin.api-logs.data') }}",
      viewTxn: "{{ url('/admin/api-logs') }}"
    };
    window.csrfToken = "{{ csrf_token() }}";
  </script>
  @vite('resources/assets/js/api-logs.js')
@endsection
      ...
      <div class="card border shadow-xs mb-4">
        ...
        <div class="card-body">
          <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 mt-3 g-3 align-items-end">
            ...
            <div class="col">
              <label>Uid</label>
              <input type="text" id="filter-uid" placeholder="Uid" class="form-control">
            </div>
