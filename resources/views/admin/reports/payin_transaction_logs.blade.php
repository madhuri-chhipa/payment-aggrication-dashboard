...
@section('title', 'Payin Transactions')
...
@section('page-script')
  <script>
    window.routes = {
      txnData: "{{ route('admin.payin-transactions.data') }}",
      viewTxn: "{{ url('admin/payin/transaction') }}",
      checkStatus: "{{ url('admin/payin/check-status') }}"
    };
    window.csrfToken = "{{ csrf_token() }}";
  </script>
  @vite('resources/assets/js/payin-txn-logs.js')
@endsection
      ...
      <div class="card border shadow-xs mb-4">
        ...
        <div class="card-header border-bottom-0 pb-0">
          <div class="d-sm-flex align-items-center">
            <div>
              <h5 class="font-weight-semibold text-lg mb-0">Payin Transactions</h5>
            </div>
          </div>
        </div>
