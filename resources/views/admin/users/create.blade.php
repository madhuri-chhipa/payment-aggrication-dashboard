    ...
    <div class="col-12 mb-6">
      <div class="bs-stepper wizard-icons wizard-icons-example mt-2" id="wizard-icons">
        ...
        <div class="bs-stepper-content">
          <form id="registerForm" method="POST" action="{{ route('admin.user.store') }}" enctype="multipart/form-data"
            novalidate>
            @csrf
            <!-- Basic Details -->
              ...
              <div class="row g-4">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" name="mobile_number" value="{{ old('mobile_number') }}"
                    placeholder="Enter Mobile Number" class="form-control" maxlength="10" required>
                  @error('mobile_number')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
              ...
              <div class="row g-4">
                ...
                <div class="col-12 d-flex justify-content-between">
                  ...
                  <button class="btn btn-primary" type="submit"><span
                      class="align-middle d-sm-inline-block d-none me-sm-2">Submit</span> <i
                      class="icon-base ti tabler-arrow-right icon-xs"></i></button>
                </div>
              </div>
            </div>
