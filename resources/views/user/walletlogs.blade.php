...
@section('page-script')
  <script>
    window.routes = {
      walletData: "{{ route('wallet-history.datatable') }}",
    };
    window.csrfToken = "{{ csrf_token() }}";
  </script>
  @vite('resources/assets/js/user-wallet-logs.js')
@endsection
        ...
        <div class="card-body">
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-3 mb-3">
            ...
            <div class="col d-flex gap-2">
              <button class="btn btn-primary w-50" id="applyFilter">
                <i class="icon-base ti tabler-filter me-1"></i> Apply
              </button>
              <button class="btn btn-outline-secondary w-50" id="resetFilter">
