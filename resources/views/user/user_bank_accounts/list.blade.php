...
@section('title', 'User Bank Accounts')
      ...
      <form id="accountForm">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">User Bank Account</h5>
          </div>
...
@section('page-script')
  <script>
    window.routes = {
      data: "{{ route('user-bank-accounts.data') }}",
      store: "{{ route('user-bank-accounts.store') }}",
      update: "{{ url('user-bank-accounts') }}",
      edit: "{{ url('user-bank-accounts') }}",
      delete: "{{ url('user-bank-accounts') }}",
      status: "{{ url('user-bank-accounts/status') }}"
    };
  </script>

  @vite('resources/assets/js/user_bank_accounts.js')
@endsection
