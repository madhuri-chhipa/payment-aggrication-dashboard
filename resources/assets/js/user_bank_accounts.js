$(function () {
      ...
      if (result.isConfirmed) {
        $.ajax({
          ...
          success: function (res) {
            Swal.fire('Deleted!', res.message ?? 'Account deleted successfully', 'success');
            table.ajax.reload(null, false);
  ...
  $(document).on('change', '.status-toggle', function () {
    ...
    $.ajax({
      ...
      success: function (res) {
        toastr.success(status ? 'Account activated successfully' : 'Account deactivated successfully');
      },
      error: function () {
